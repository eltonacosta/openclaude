/**
 * End-to-end verification that `npm install -g @eltonacosta/openclaude` is a
 ...
 *                       @eltonacosta/openclaude@latest). Used by the scheduled
...
const PACKAGE_NAME = '@eltonacosta/openclaude'
