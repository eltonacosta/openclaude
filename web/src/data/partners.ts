...
export const community = [
  { name: 'github', url: 'https://github.com/eltonacosta/orbit-code', label: 'star the repo' },
  { name: 'discord', url: 'https://discord.gg/k68zFR6AcB', label: 'join the discord' },
  { name: 'x', url: 'https://x.com/gitlawb', label: 'follow @gitlawb' },
  { name: 'discussions', url: 'https://github.com/eltonacosta/orbit-code/discussions', label: 'open a discussion' },
