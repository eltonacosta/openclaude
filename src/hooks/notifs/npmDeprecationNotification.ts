...
const NPM_DEPRECATION_MESSAGE =
  'OpenClaude has switched from npm to the native installer. Run `openclaude install` or see https://github.com/eltonacosta/openclaude#quick-start for more options.'
