    ...
    await withTempTranscript(
      [
        ...
        },
        {
          ...
          sessionId,
          prNumber: 456,
          prUrl: 'https://github.com/eltonacosta/openclaude/pull/456',
          prRepository: 'eltonacosta/openclaude',
          timestamp: '2026-06-27T08:01:00.000Z',
        },
        userMessage(
          '00000000-0000-4000-8000-000000000008',
          'Update src/report.ts for https://github.com/eltonacosta/openclaude/issues/123.',
          '2026-06-27T08:00:00.000Z',
        ),
        assistantToolMessage(
      ...
      async transcriptPath => {
        ...
        expect(report.branch.pullRequest).toEqual({
          number: 456,
          repository: 'eltonacosta/openclaude',
          url: 'https://github.com/eltonacosta/openclaude/pull/456',
        })
        ...
        expect(report.linkedReferences).toEqual([
          {
            ...
            number: 123,
            repository: 'eltonacosta/openclaude',
            url: 'https://github.com/eltonacosta/openclaude/issues/123',
          },
          {
            kind: 'pull_request',
            number: 456,
    ...
    await withTempTranscript(
      [
        ...
        toolResultMessage(
          ...
          'tool-read',
          'File body mentions https://github.com/eltonacosta/openclaude/issues/999.',
          '2026-06-27T08:01:01.000Z',
        ),
      ],
      async transcriptPath => {
  ...
  test('formats markdown for changed files and branch metadata', async () => {
    ...
    await withTempTranscript(
      ...
      async transcriptPath => {
        ...
        expect(markdown).toContain(
          '- Pull request: [#456](<https://github.com/eltonacosta/openclaude/pull/456>) (`eltonacosta/openclaude`)',
        )
        expect(markdown).toContain(`- \`${reportSourcePath}\` (git, tool)`)
        expect(markdown).toContain(`- \`${reportTestPath}\` (git)`)
        expect(markdown).toContain(
          '- pull_request: [#456](<https://github.com/eltonacosta/openclaude/pull/456>) (`eltonacosta/openclaude`)',
        )
      },
    )
  })
  ...
  test('sanitizes linked reference markdown URLs', async () => {
    await withTempTranscript(
      ...
      async transcriptPath => {
        ...
        report.linkedReferences = [
          {
            ...
            number: 321,
            repository: 'eltonacosta/openclaude',
            url: 'https://github.com/eltonacosta/openclaude/issues/321?label=a(b)',
          },
          {
            kind: 'pull_request',
            number: 9,
        ...
        expect(markdown).toContain(
          '- issue: [#321](<https://github.com/eltonacosta/openclaude/issues/321?label=a(b)>) (`eltonacosta/openclaude`)',
        )
